...
<div class="container-fluid">
    <a class="navbar-brand" href="inicio.php">ROPA AL 50%  Descuento</a>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <img src="vestido.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title"> Vestido Rojo</h5>
                        <p class="card-text">Talla: S</p>
                        <p class="card-text">Precio $500.00MNX</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="trajede.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Bañador bikini</h5>
                        <p class="card-text">TALLA: S--M</p>
                        <p class="card-text"> Precio $150.00 MNX</p>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <img src="goku.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Traje de Bebe SonGoku</h5>
                        <p class="card-text">Talla: CH--M</p>
                        <p class="card-text">Precio $200.00 MNX</p>
                        <p class="card-text">Stock: 11</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="articulo 3" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="dine.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Camisa de NIÑO (DINERO)</h5>
                        <p class="card-text">Talla: CH--M</p>
                        <p class="card-text">Precio $250.00 MNX</p>
                        <p class="card-text">Stock:31</p>
                        <button class="btn btn-primary" type="submit" ><i class="fas fa-shopping-cart"></i> Añadir al carrito</button>
                </div>
        </form>
</div>
...
<div class="card m-4" style="width: 18rem;">
        ...
        <input name="titulo" type="hidden" id="titulo" value="articulo 3" />
        <input name="cantidad" type="hidden" id="cantidad" value="1" class="pl-2" />
        <img src="tono.png" class="card-img-top" alt="...">
                <div class="card-body">
                        <h5 class="card-title">Playera niño DOS TONOS</h5>
                        <p class="card-text">Talla: CH--M</p>
                        <p class="card-text">Precio $150.00 MNX</p>
